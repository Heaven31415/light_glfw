...
lib LibGLFW
  ...
  fun get_physical_device_presentation_support = glfwGetPhysicalDevicePresentationSupport(instance : VkInstance*, device : VkPhysicalDevice*, queuefamily : UInt32) : Int32
  fun create_window_surface = glfwCreateWindowSurface(instance : VkInstance*, window : Window*, allocator : VkAllocationCallbacks*, surface : VkSurfaceKHR*) : Int32
end