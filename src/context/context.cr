module GLFW
  ...
  # `#window_hint_context_release_behavior` method.
  #
  ...
  # `#swap_buffers` was called before swapping the buffers and returning. This
  ...
  # You can check for the presence of these extensions using `#extension_supported`.
  ...
  #  until the buffers are swapped by `#swap_buffers`.
  #
  ...
  # `#get_required_instance_extensions`, `vkEnumerateInstanceExtensionProperties`
  ...
  #
  # This function does not apply to Vulkan. If you are rendering with Vulkan,
  # see `#get_instance_proc_address`, `vkGetInstanceProcAddr` and
